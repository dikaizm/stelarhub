...
import { Collab, Quality, Skill, Tech } from '@/assets/IconImg';
...
const heroDesc: string = "Kami menciptakan pengalaman digital yang luar biasa untuk membawa merek Anda menuju kesuksesan. Dengan keahlian di bidang situs web, aplikasi, dan branding, kami menggabungkan kreativitas dan teknologi untuk mewujudkan visi Anda."

const splitArrayHalf = (arr: Service[] | undefined) => {
...
function FeatItem({ children, icon: Icon }: FeatItemProps) {
  return (
    <div className="feat-item">
      <Icon />
      <p className='item-label'>{children}</p>
    </div>
  )
}
...
export default function Home({ latestWorks = [], recommendedWorks = [], services = [] }: HomeProps) {
  ...
  return (
    <AppLayout id='home' head='Beranda'>
        ...
        <div className="flex-col">
          <div className="container content-w-big">
            <div className="flex-row">
              ...
              <p className="hero-desc-big">{heroDesc}</p>
            </div>
            ...
            <p className="hero-desc-m">{heroDesc}</p>
          </div>

          <div className="bg-white feat-container">
            <div className="container grid-wrapper">
              <FeatItem icon={Skill}>Tim Berpengalaman</FeatItem>
              <FeatItem icon={Tech}>Tech Savvy</FeatItem>
              <FeatItem icon={Quality}>Komitmen pada Kualitas</FeatItem>
              <FeatItem icon={Collab}>Pendekatan Kolaboratif</FeatItem>
            </div>
          </div>
        </div>
      </section>
