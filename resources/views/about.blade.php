...
@section('content')
  ...
  <section class="container">
    <div class="relative flex flex-col items-center justify-between gap-16 my-32 sm:my-48 sm:flex-row">
      <div class="flex flex-col max-w-xl gap-12">
        <h1 class="text-5xl font-extrabold lg:text-6xl gradient-blue">Dedicated Teams for Your Dedicated Dreams</h1>
      ...
      <img class="object-contain w-full max-w-lg sm:w-1/2 -rotate-6 rounded-2xl drop-shadow-2xl" src="assets/hero-about.png"
        alt="">
    </div>
  </section>
    ...
    <div class="relative flex flex-col justify-center gap-12">
      ...
      <div class="grid gap-8 grid-auto-fit-xl">
        ...
        <div class="card">
          ...
          <p class="card-content">We believe that the best outcomes are achieved through strong partnerships and teamwork.
          </p>
        </div>
        <div class="card">
  ...
  <section class="container my-32 sm:my-48">
    ...
    <div class="flex flex-col-reverse gap-8 mt-16 sm:grid grid-auto-fit">
      <div class="flex justify-center mt-4 sm:justify-normal gap-x-5">
      ...
      <div class="relative">
        <svg class="absolute w-12 h-fit text-sky-400" viewBox="0 0 42 34" fill="currentColor"
  ...
  {{-- Team section --}}
  <section class="py-32 mt-32 container-full bg-neutral-100">
    <div class="container">
      <h2 class="text-center section-title">Meet our amazing team</h2>
      <div class="grid mt-24 sm:grid-cols-2 gap-y-12">
        <div class="flex flex-col gap-6 px-8 sm:px-16 md:px-24 xl:px-36">
          <img class="object-contain rounded-full" src="assets/team-01.png" alt="">
      ...
      <p class="mt-24 text-3xl text-center sm:text-4xl">Getting good players is easy. <br>Getting them to play together is the hard part.</p>
    </div>
  </section>
@endsection
